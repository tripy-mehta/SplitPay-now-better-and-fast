...
10+ real users connected Freighter, joined a group, logged an expense, and completed an on-chain settlement on testnet.

**[Google Form (Feedback Survey)](https://forms.google.com/your-form-link-here)**  
**[Excel Sheet (Form Responses)](https://docs.google.com/spreadsheets/your-sheet-link-here)**

### User Onboarding

| Name | Email | Wallet Address |
|---|---|---|
| User 1 | user1@example.com | `GBPSN5J76XHRFM6AVHJUOJOXVOWK4HU2W5FU57UYIPUZ743CT4TQAHUA` |
| User 2 | user2@example.com | `GCH24NLVNA5KGGS2HDEDUDAEHSQ53S3ORRVS4S7DM2DW2FVRTFIOVWBF` |
| User 3 | user3@example.com | `GCK6CIORZYHZPHIEURTCGOWXMIZG7QPZ367ZHLGXMANM7GS7VZQBRZZP` |
| User 4 | user4@example.com | `GDTHXNSTSQUXUDD7R7DMWF6IQMWLTIBNVSMOWNL7I67YIY7ATWMFKV3Q` |
| User 5 | user5@example.com | `GBV2IC2KIYY7I4C3PVNFH2LWLF54IK6JSGTXNRBUZ7CK337OZL3EXURN` |
| User 6 | user6@example.com | `GCZX5UH63WE5E65CNWXSGFZGGYVRWTNIFR2XXKTFH7MJKYQJUUPFYXX3` |
| User 7 | user7@example.com | `GA4LXXDHEF4EPSHKNH62V6GN4CRYNFCUQJ37PHJD7BH2MSWOONWFBLKR` |
| User 8 | user8@example.com | `GC6F5FDMQXXY5VUSSVNSID36KQVZUNCORQQ4DLRV24ECLBI6FLPMAYPB` |
| User 9 | user9@example.com | `GBYU6MJQPMGSDPJI4PK6GUVFNOQ75ROXH63JHGEHTNK2RIKUFEBOYEIB` |
| User 10 | user10@example.com | `GDU7W3YTWZN3PKEVYVFCHHJZLUMUZOQROBYL2FLB5VD4SME7TUYA7YDO` |
...
|---|---|---|---|---|
| User 1 | `GBPSN...AHUA` | "Would be great to see my transaction history." | Added Expense History UI | [Commit Link] |
